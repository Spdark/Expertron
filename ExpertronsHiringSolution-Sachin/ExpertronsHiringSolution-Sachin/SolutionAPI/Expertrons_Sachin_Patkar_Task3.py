...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
	<soapenv:Header>
		<com:AUFHeaderRespo nse xmlns:com="http://schemas.auf.com/integration/common">
			<com:RequestId>C87892894718158925</co m:RequestId>
	...
	<soapenv:Body>
		<ns2:GetCustomer360Deta ilsResponse xmlns:ns2="http://schemas.auf.com/integration/customer">
			<ns2:TransactionStatus>
				...
				<com:ResponseMess age xmlns:com="http://schemas.auf.com/integration/common">Success</com:ResponseMessage>
			...
			<ns2:CustomerResponse>
				<ns2:CustomerBasicInquiry>
					...
					<com:Natio nalIdentificationCode xmlns:com="http://schemas.auf.com/integration/common">8751</com:NationalIdentificationCode>
					<co m:CustomerName xmlns:com="http://schemas.auf.com/integration/common">
						<com:Prefix>MR.</com:Prefix>
						<com:FirstNa me>RAJ</com:FirstName>
					...
					<com:Categ oryType xmlns:com="http://schemas.auf.com/integration/common">INDIVIDUAL - FULL KYC</com:CategoryType>
					...
					<com:IsSignatur eAvailable xmlns:com="http://schemas.auf.com/integration/common">true</com:IsSignatureAvailable>
					<com:Comb WithdrawBal xmlns:com="http://schemas.auf.com/integration/common">0.0</com:CombWithdrawBal>
					<com:AgeOfCu stRel xmlns:com="http://schemas.auf.com/integration/common">2019-06-25</com:AgeOfCustRel>
					...
					<com:EmailAddress xmlns:com="http://schemas.auf.com/integration/common">gdhs76dsban45@gmail.com</com:EmailAddr ess>
			...
			<ns2:AccountDetails>
				<com:CustomerAccount xmlns:com="http://schemas.auf.com/integration/common">
					...
					<com:CurrencyShortNa me>INR</com:CurrencyShortName>
					...
					<com:AvailableBala nce>0.00</com:AvailableBalance>
...
mn = []
mn.append(soup.find('com:MobileNo'))
mn.append(soup.find('com:MobileNumber'))
r = []
for i in range(len(mn)):
	r.append([j for j in mn[i] if j.isnumeric()])
for i in range(len(r)):
	url = "https://api.datayuge.com/v1/lookup/"+r[i][0]
